...
---
## [18]{.cn} [: ]{.hid1} There's No Actual Skill Called 'Business' {#theres-no-actual-skill-called-business .calibre14}
Avoid business schools and magazines
### There's no actual skill called 'business' {#toc_1 .sec}
[Naval:]{.bldcol} In that sense, business to me is bottom of the barrel. There's no actual skill called business, it's too generic. It's like a skill called "relating." Like "relating to humans." That's not a skill, it's too broad.
...
### Doing is faster than watching {#toc_2 .sec}
[Nivi:]{.bldcol} What did you mean when you said that "doing is faster than watching?"
[Naval:]{.bldcol} When it comes to your learning curve, if you want to optimize your learning curve... One of the reasons why I don't love podcasts, even though I'm a generator of podcasts, is that I like to consume my information very quickly.
...
### The number of 'doing' iterations drives the learning curve {#toc_3 .sec}
...
### If you're willing to bleed a little every day, you may win big later {#toc_4 .sec}
