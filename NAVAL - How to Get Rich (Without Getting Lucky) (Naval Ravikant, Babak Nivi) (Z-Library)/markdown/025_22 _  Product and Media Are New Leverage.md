...
---
## [22]{.cn} [: ]{.hid1} Product and Media Are New Leverage {#product-and-media-are-new-leverage .calibre14}
Create software and media that work for you while you sleep
### Product and media are the new leverage {#toc_1 .sec}
[Naval:]{.bldcol} The most interesting and the most important form of leverage is this idea of products that have no marginal cost of replication. This is the new form of leverage.
...
### Product leverage is where the new fortunes are made {#toc_2 .sec}
...
### Combining all three forms of leverage is a magic combination {#toc_3 .sec}
...
### Product and media leverage are permissionless {#toc_4 .sec}
[Nivi:]{.bldcol} Do you want to talk a little bit about permissioned versus permissionless?
[Naval:]{.bldcol} Probably the most interesting thing to keep in mind about the new forms of leverage is they are permissionless. They don't require somebody else's permission for you to use them or succeed.
...
### The robot army is already here---code lets you tell them what to do {#toc_5 .sec}
