...
---
## [46]{.cn} [: ]{.hid1} Compounding Relationships Make Life Easier {#compounding-relationships-make-life-easier .calibre14}
Life gets a lot easier when you know someone's got your back
### Mutual trust makes it easy to do business {#toc_1 .sec}
...
If I'm doing a deal with someone I've worked with for 20 years and there is mutual trust, we don't have to read the legal contracts. Maybe we don't even need to [create legal contracts; maybe we can do it with a handshake. That kind of trust makes it very easy to do business.]{.calibre8}
...
### It's better to have a few compounding relationships than many shallow ones {#toc_2 .sec}
[Nivi:]{.bldcol} There are a couple of non-intuitive things about compounding. The first is that most of the benefits come at the end, so you may not see huge benefits up front.
Sam Altman wrote, ["I always want it to be a project that, if successful, will make the](http://blog.samaltman.com/how-to-be-successful){.nound} [rest of my career look like a footnote.](http://blog.samaltman.com/how-to-be-successful){.nound}" Again, most of the benefits of compounding come at the end.
...
### It takes just as much effort to create a small business as a large one {#toc_3 .sec}
[Naval:]{.bldcol} One thing about business that people don't realize: it takes just as much effort to create a small business as it does to create a large one.
