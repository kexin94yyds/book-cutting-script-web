...
---
## [49]{.cn} [: ]{.hid1} Net Present Value: What Future Income Is Worth Today {#net-present-value-what-future-income-is-worth-today .calibre14}
See what future income is worth today by applying a discount to its future value
### Figure out what future income is worth today by applying a discount rate {#toc_1 .sec}
[Nivi:]{.bldcol} Let's talk about [net present value](https://en.wikipedia.org/wiki/Net_present_value){.nound} (NPV).
[Naval:]{.bldcol} Net present value is when you say, "That stream of payments I'm going to get in the future---what's it worth today?"
