...
---
## [45]{.cn} [: ]{.hid1} Turn Short-Term Games Into Long-Term Games {#turn-short-term-games-into-long-term-games .calibre14}
Improve your leverage by turning short-term relationships into long-term ones
### Pareto optimal solutions require a trade-off to improve any criterion {#toc_1 .sec}
[Nivi:]{.bldcol} Do you want to talk about [Pareto optimal?](https://en.wikipedia.org/wiki/Pareto_efficiency){.nound}
[Naval:]{.bldcol} Pareto optimal is another concept from game theory, along with Pareto superior.
...
### Negotiations are won by whoever cares less {#toc_2 .sec}
I generally say, though: ["Negotiations are won by whoever cares less.](https://twitter.com/naval/status/818630258916139008?lang=en){.nound}" Negotiation is about not wanting it too badly. If you want something too badly, the other person can extract more value from you.
...
### Convert single-move games to multi-move games {#toc_3 .sec}
