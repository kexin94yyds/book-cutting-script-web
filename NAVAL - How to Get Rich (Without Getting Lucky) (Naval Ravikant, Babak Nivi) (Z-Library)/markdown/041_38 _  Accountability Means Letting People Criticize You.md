...
---
## [38]{.cn} [: ]{.hid1} Accountability Means Letting People Criticize You {#accountability-means-letting-people-criticize-you .calibre14}
You have to stick your neck out and be willing to fail publicly
### Accountability means letting people criticize you {#toc_1 .sec}
[Nivi:]{.bldcol} We finished discussing the tweetstorm. We're going to spend some time on Q&A and discussing tweets that didn't make it into the ["How to Get Rich"](https://twitter.com/naval/status/1002103360646823936){.nound} tweetstorm. My first question: What are some common failures or things people typically do wrong when they try to apply this advice?
[Naval:]{.bldcol} A lot of people don't understand what specific knowledge is or how to "obtain" it. People don't understand what accountability entails. They think accountability means being successfully accountable. No---it means you have to stick your neck out and fail publicly. You have to be willing to let people criticize you.
...
### The most interesting parts should be the ones you disagree with {#toc_2 .sec}
...
### Get the free leverage that's available in tech {#toc_3 .sec}
Some people will say, "This only applies to tech entrepreneurs." I disagree. The [[real]{.calibre18}](https://nav.al/laborer-tech){.nound}[ ]{.calibre18}[estate example](https://nav.al/laborer-tech){.nound} was a good one in that regard.
...
### Don't refuse to do things just because others can't do them {#toc_4 .sec}
...
### Realize your philanthropic vision by running a business {#toc_5 .sec}
...
There is a word environmentalists love: [sustainability. If nothing else, for-profit businesses are financially sustainable. You can do a]{.calibre8} [B Corporation,](https://bcorporation.net/){.nound} which has a dual mission.
