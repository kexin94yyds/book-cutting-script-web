...
---
## [2]{.cn} [: ]{.hid1} Make Abundance for the World {#make-abundance-for-the-world .calibre14}
Wealth isn't about taking something from somebody else
### Ethical wealth creation makes abundance for the world {#toc_1 .sec}
[Naval:]{.bldcol} I think there is this notion that making money is evil, right? It's rooted all the way back down to "money is the root of all evil." People think that the bankers steal our money. It's somewhat true in that, in a lot of the world, there's a lot of theft going on all the time.
...
### Everyone can be rich {#toc_2 .sec}
